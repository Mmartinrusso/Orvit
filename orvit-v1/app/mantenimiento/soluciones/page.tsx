...
function mapToSolution(sa: any): Solution {
  return {
    ...
    componentName: (sa as any).finalComponent?.name || sa.failureOccurrence?.component?.name,
    componentId: (sa as any).finalComponent?.id || sa.failureOccurrence?.component?.id,
    subcomponentNames: (sa as any).finalSubcomponent?.name || sa.failureOccurrence?.subComponent?.name || undefined,
    ...
    toolsUsed: Array.isArray(sa.toolsUsed) ? sa.toolsUsed : undefined,
    sparePartsUsed: Array.isArray(sa.sparePartsUsed) ? sa.sparePartsUsed : undefined,
    actualMinutes: sa.actualMinutes,
    notes: sa.notes,
    fixType: sa.fixType,
