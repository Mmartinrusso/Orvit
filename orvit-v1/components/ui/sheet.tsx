...
const sheetVariants = cva(
  'fixed z-[150] gap-0 bg-background shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300 flex flex-col',
  {
    variants: {
      side: {
      ...
      size: {
        // Anchos estandarizados para side left/right
        sm: 'w-full sm:w-[350px]',
        default: 'w-full sm:w-[450px]',
        md: 'w-full sm:w-[550px]',
  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      onPointerDownOutside={(e) => {
        // Permitir que dropdowns/popovers internos no cierren el sheet
    ...
    >
      ...
      <SheetPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary sm:hidden">
        <X className="h-4 w-4" />
