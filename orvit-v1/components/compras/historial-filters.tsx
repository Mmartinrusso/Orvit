    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2 flex-wrap">
        ...
        <Button
          ...
          size="sm"
          className={`h-6 text-[10px] px-2 ${filters.quickFilter !== 'aprobaciones' ? 'bg-green-50 hover:bg-green-100 text-green-700 border-green-200' : ''}`}
        ...
        <Button
          ...
          size="sm"
          className={`h-6 text-[10px] px-2 ${filters.quickFilter !== 'rechazos' ? 'bg-red-50 hover:bg-red-100 text-red-700 border-red-200' : ''}`}
