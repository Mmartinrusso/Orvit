...
export function StockConfigModal({
 ...
 <span className="w-2 h-2 rounded-full bg-destructive/100" />
 A - Alta rotación / Alto valor
 </div>
 </SelectItem>
 <SelectItem value="B">
 <div className="flex items-center gap-2">
 <span className="w-2 h-2 rounded-full bg-warning-muted0" />
 B - Media rotación / Medio valor
 </div>
 </SelectItem>
 <SelectItem value="C">
 <div className="flex items-center gap-2">
 <span className="w-2 h-2 rounded-full bg-success-muted0" />
 ...
 {/* Info box */}
 <div className="bg-info-muted border border-info-muted rounded-lg p-3 flex gap-2">
 <Info className="h-4 w-4 text-info-muted-foreground mt-0.5 shrink-0" />
