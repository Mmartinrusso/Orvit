...
export function DevolucionFromDocumentModal({
 ...
 {!item.hasValidSupplierItem && (
 <Badge variant="outline" className="text-xs text-warning-muted-foreground border-warning-muted shrink-0" title="Item sin producto vinculado - no se puede devolver">
 Sin stock
 </Badge>
 )}
 </div>
