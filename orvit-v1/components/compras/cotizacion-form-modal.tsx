          ...
          {mode === 'manual' && (
            <>
              ...
              {aiExtraction && (
                <Card className={cn(
                  "p-3 mb-4",
                  aiConfidence >= 0.8 ? "bg-green-50 border-green-200" : "bg-amber-50 border-amber-200"
                )}>
              ...
              <Tabs defaultValue="items" className="w-full">
                ...
                <TabsContent value="condiciones" className="space-y-4 mt-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {pdfFile ? (
                      <Card className="p-3 flex items-center justify-between bg-green-50/50 border-green-200">
