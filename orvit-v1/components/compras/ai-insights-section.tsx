...
async function fetchInsightsData(): Promise<Insight[]> {
...
export function AIInsightsSection() {
 ...
 queryKey: ['compras-ai-insights'],
 queryFn: fetchInsightsData,
 staleTime: 5 * 60 * 1000,
 });

 const handleRefresh = () => queryClient.invalidateQueries({ queryKey: ['compras-ai-insights'] });
 ...
 <p className="text-sm text-muted-foreground">No se pudieron cargar los insights</p>
