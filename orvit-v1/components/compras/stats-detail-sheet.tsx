      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Card>
          <CardContent className="pt-4">
            ...
            <div className="flex items-center gap-1 mt-1">
              {variacionMes !== 0 && (
                <span className={`flex items-center gap-0.5 text-xs ${variacionMes > 0 ? 'text-red-500' : 'text-green-500'}`}>
        ...
        <Card>
          <CardContent className="pt-4">
            ...
            <div className="flex items-center gap-1 mt-1">
              {variacionYoY !== 0 && (
                <span className={`flex items-center gap-0.5 text-xs ${variacionYoY > 0 ? 'text-red-500' : 'text-green-500'}`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Card className={data.resumen?.facturasVencidas > 0 ? "bg-red-500/10" : "bg-green-500/10"}>
          <CardContent className="pt-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              { key: 'vencido90', label: '+90 días vencido', color: 'bg-red-700' },
              { key: 'vencido60', label: '60-90 días vencido', color: 'bg-red-600' },
              { key: 'vencido30', label: '30-60 días vencido', color: 'bg-red-500' },
              { key: 'vencido', label: '0-30 días vencido', color: 'bg-red-400' },
              { key: 'dias7', label: 'Próximos 7 días', color: 'bg-amber-500' },
              { key: 'dias15', label: '8-15 días', color: 'bg-yellow-500' },
              { key: 'dias30', label: '16-30 días', color: 'bg-blue-500' },
              { key: 'mas30', label: 'Más de 30 días', color: 'bg-gray-400' },
            ].map((item) => {
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
              ...
              <div className={`text-2xl font-bold ${data.metricas.tasaRechazo > 5 ? 'text-red-500' : 'text-green-500'}`}>
          ...
          <CardContent>
            <div className="space-y-2">
              {data.pendientesAprobacion.map((o: any) => (
                <div
                  key={o.id}
                  className="flex items-center justify-between p-2 rounded bg-amber-500/5 hover:bg-amber-500/10 cursor-pointer"
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-amber-600">{o.diasPendiente} días esperando</p>
                  </div>
                </div>
              ))}
            </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-5 gap-2">
        {[
          { key: 'proximo7', label: '7 días', color: 'bg-red-500/10' },
          { key: 'proximo15', label: '15 días', color: 'bg-amber-500/10' },
          { key: 'proximo30', label: '30 días', color: 'bg-yellow-500/10' },
          { key: 'proximo60', label: '60 días', color: 'bg-blue-500/10' },
          { key: 'proximo90', label: '90 días', color: 'bg-gray-500/10' },
        ].map((item) => (
      ...
      {data.resumen?.proximo7?.facturas && data.resumen.proximo7.facturas.length > 0 && (
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-amber-600">Vencen en 7 días</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
          ...
          <CardContent>
            <div className="grid grid-cols-4 gap-4">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{data.metricas.clasificacionABC?.A || 0}</p>
                <p className="text-xs text-muted-foreground">items críticos</p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Clase B (15%)</p>
                <p className="text-2xl font-bold text-amber-600">{data.metricas.clasificacionABC?.B || 0}</p>
                <p className="text-xs text-muted-foreground">items intermedios</p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Clase C (5%)</p>
                <p className="text-2xl font-bold text-gray-600">{data.metricas.clasificacionABC?.C || 0}</p>
            ...
            <TableRow key={item.descripcion}>
              ...
              <TableCell className="text-right">
                {item.variacionPrecio > 0 && (
                  <span className={`text-xs ${item.variacionPrecio > 20 ? 'text-red-500' : 'text-muted-foreground'}`}>
        ...
        <Card>
          <CardContent className="pt-4">
            ...
            <div className="flex items-center gap-1">
              {variacion !== 0 && (
                <span className={`text-xs ${variacion > 0 ? 'text-green-500' : 'text-red-500'}`}>
        ...
        <Card className="bg-blue-500/5 border-blue-500/20">
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              ...
              <div className={`text-2xl font-bold ${data.metricas.tasaDiferencias > 10 ? 'text-red-500' : 'text-green-500'}`}>
            ...
            <div className="space-y-2">
              {data.leadTimeProveedores.map((p: any) => (
                <div key={p.proveedorId} className="flex items-center justify-between p-2 bg-muted/30 rounded">
                  ...
                  <div className="text-right">
                    <p className={`text-lg font-bold ${p.leadTimeDias > 15 ? 'text-amber-500' : 'text-green-500'}`}>
              ...
              {data.proxVencimientos.map((p: any) => (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className={`text-xs ${p.diasRestantes <= 30 ? 'text-amber-600' : 'text-muted-foreground'}`}>
