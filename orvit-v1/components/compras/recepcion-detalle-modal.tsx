  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[90vw] max-w-[95vw] max-h-[92vh] overflow-y-auto p-0">
          <div className="p-8">
            ...
            <div className="space-y-6">
              ...
              {(recepcion.notas || recepcion.observacionesRecepcion) && (
                <div className="border rounded-xl p-5 bg-amber-50/50 dark:bg-amber-900/10 border-amber-200 dark:border-amber-800/30">
      ...
      <Dialog open={showEvidenciaModal} onOpenChange={setShowEvidenciaModal}>
        <DialogContent className="sm:max-w-4xl max-w-[95vw] p-0">
          <div className="p-8">
            <DialogHeader className="pb-6 border-b mb-6">
              <DialogTitle className="flex items-center gap-3 text-xl">
              ...
              {recepcion?.firma && (
                <div className="bg-muted/30 rounded-xl p-6">
                  ...
                  <div className="flex justify-center">
                    <div className="bg-white border-2 border-dashed border-muted-foreground/30 rounded-xl p-6 max-w-md w-full">
                      <img
                        src={recepcion.firma}
