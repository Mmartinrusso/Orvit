                ...
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="flex gap-4">
                    <div>
                      ...
                      <Badge
                        className={cn(
                          result.pedido.prioridad === 'URGENTE' && 'bg-red-100 text-red-700',
                          result.pedido.prioridad === 'ALTA' && 'bg-orange-100 text-orange-700',
                          result.pedido.prioridad === 'NORMAL' && 'bg-blue-100 text-blue-700',
                          result.pedido.prioridad === 'BAJA' && 'bg-gray-100 text-gray-700'
                        )}
                      >
