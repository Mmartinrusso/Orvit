...
export function KpiSystemCard({ data }: { data: DashboardSummary; range: RangeKey }) {
  ...
  return (
    ...
    >
      <div className="text-3xl font-normal leading-none tabular-nums mb-0.5">{k.activeUsers}</div>
      ...
      <p className="text-[11px] text-muted-foreground leading-tight">Actividad reciente</p>
