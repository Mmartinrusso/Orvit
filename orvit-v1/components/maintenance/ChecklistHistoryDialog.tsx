...
export default function ChecklistHistoryDialog({
 ...
 <div className="flex items-center justify-center py-8">
 <div className="text-muted-foreground">No hay historial de checklists disponible</div>
 </div>
 ) : (
 ...
 <Card key={index} className="border-warning-muted bg-warning-muted">
 <CardContent className="p-4">
 <div className="space-y-3">
 <div className="flex items-center gap-2">
 <h4 className="font-medium text-foreground">{justification.itemTitle}</h4>
