...
export function MaintenanceAlertsCard({
 ...
 return (
 <Card className={cn(className, summary?.critical && summary.critical > 0 && 'border-destructive/30')}>
 <CardHeader className="pb-2">
 ...
 {summary.dueToday > 0 && (
 <Badge className="text-xs bg-warning-muted text-warning-muted-foreground hover:bg-warning-muted">
