...
// Permisos de Máquinas que necesitamos asignar
...
async function assignMaquinasPermissionsToAdmin() {
  try {
    console.log(`🚀 Asignando permisos de Máquinas al rol "${ROLE_NAME}" en todas las empresas...\n`);
    ...
    for (const company of companies) {
      ...
      try {
        ...
        for (const permissionName of MAQUINAS_PERMISSIONS) {
          try {
            // Buscar el permiso
    ...
    console.log(`🎯 Permisos por rol: ${MAQUINAS_PERMISSIONS.length}`);
...
assignMaquinasPermissionsToAdmin();
