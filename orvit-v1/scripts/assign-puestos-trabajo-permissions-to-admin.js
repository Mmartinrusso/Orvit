...
// Permisos de Puestos de Trabajo que necesitamos asignar
...
async function assignPuestosTrabajoPermissionsToAdmin() {
  try {
    console.log(`🚀 Asignando permisos de Puestos de Trabajo al rol "${ROLE_NAME}" en todas las empresas...\n`);
    ...
    for (const company of companies) {
      ...
      try {
        ...
        for (const permissionName of PUESTOS_TRABAJO_PERMISSIONS) {
          try {
            // Buscar el permiso
    ...
    console.log(`🎯 Permisos por rol: ${PUESTOS_TRABAJO_PERMISSIONS.length}`);
...
assignPuestosTrabajoPermissionsToAdmin();
