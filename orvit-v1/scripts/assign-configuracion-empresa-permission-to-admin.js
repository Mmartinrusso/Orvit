...
// Permiso de configuración de empresa que necesitamos asignar
const PERMISSION_NAME = 'configuracion_empresa';

async function assignConfiguracionEmpresaPermissionToAdmin() {
  try {
    console.log(`🚀 Asignando permiso de configuración de empresa al rol "${ROLE_NAME}" en todas las empresas...\n`);
...
assignConfiguracionEmpresaPermissionToAdmin();
