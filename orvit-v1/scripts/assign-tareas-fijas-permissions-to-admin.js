...
// Permisos de tareas fijas que necesitamos asignar
...
async function assignTareasFijasPermissionsToAdmin() {
  try {
    console.log(`🚀 Asignando permisos de tareas fijas al rol "${ROLE_NAME}" en todas las empresas...\n`);
...
assignTareasFijasPermissionsToAdmin();
