...
// Permisos de Unidades Móviles que necesitamos asignar
...
async function assignUnidadesMovilesPermissionsToAdmin() {
  try {
    console.log(`🚀 Asignando permisos de Unidades Móviles al rol "${ROLE_NAME}" en todas las empresas...\n`);
    ...
    for (const company of companies) {
      ...
      try {
        ...
        for (const permissionName of UNIDADES_MOVILES_PERMISSIONS) {
          try {
            // Buscar el permiso
    ...
    console.log(`🎯 Permisos por rol: ${UNIDADES_MOVILES_PERMISSIONS.length}`);
...
assignUnidadesMovilesPermissionsToAdmin();
