...
// Permisos de editar, eliminar y duplicar que necesitamos asignar
...
async function assignEditDeleteDuplicatePermissionsToAdmin() {
  try {
    console.log(`🚀 Asignando permisos de editar, eliminar y duplicar al rol "${ROLE_NAME}" en todas las empresas...\n`);
    ...
    for (const company of companies) {
      ...
      try {
        ...
        for (const permissionName of EDIT_DELETE_DUPLICATE_PERMISSIONS) {
          try {
            // Buscar el permiso
    ...
    console.log(`🎯 Permisos por rol: ${EDIT_DELETE_DUPLICATE_PERMISSIONS.length}`);
...
assignEditDeleteDuplicatePermissionsToAdmin();
