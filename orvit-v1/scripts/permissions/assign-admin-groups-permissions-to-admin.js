...
// Permisos de grupos del sidebar de Administración que necesitamos asignar
...
async function assignAdminGroupsPermissionsToAdmin() {
  try {
    console.log(`🚀 Asignando permisos de grupos del sidebar de Administración al rol "${ROLE_NAME}" en todas las empresas...\n`);
...
assignAdminGroupsPermissionsToAdmin();
