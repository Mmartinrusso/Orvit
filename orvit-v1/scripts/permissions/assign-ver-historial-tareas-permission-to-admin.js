...
// Permiso de historial de tareas que necesitamos asignar
const PERMISSION_NAME = 'ver_historial_tareas';

async function assignVerHistorialTareasPermissionToAdmin() {
  try {
    console.log(`🚀 Asignando permiso de historial de tareas al rol "${ROLE_NAME}" en todas las empresas...\n`);
...
assignVerHistorialTareasPermissionToAdmin();
