...
// Permisos de Mantenimientos que necesitamos asignar
...
async function assignMantenimientosPermissionsToAdmin() {
  try {
    console.log(`🚀 Asignando permisos de Mantenimientos al rol "${ROLE_NAME}" en todas las empresas...\n`);
    ...
    for (const company of companies) {
      ...
      try {
        ...
        for (const permissionName of MANTENIMIENTOS_PERMISSIONS) {
          try {
            // Buscar el permiso
    ...
    console.log(`🎯 Permisos por rol: ${MANTENIMIENTOS_PERMISSIONS.length}`);
...
assignMantenimientosPermissionsToAdmin();
