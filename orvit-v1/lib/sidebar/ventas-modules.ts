...
export const VENTAS_MODULES: SidebarModule[] = [
  ...
  // === CICLO O2C (Order-to-Cash) ===
  {
    ...
    permission: 'ventas.cotizaciones.view',
    isCore: true,
    category: 'core',
  ...
  },
  {
    ...
    permission: 'ventas.ordenes.view',
    isCore: true,
    category: 'core',
  ...
  },
  {
    ...
    permission: 'ventas.entregas.view',
    isCore: true,
    category: 'core',
  ...
  },
  {
    ...
    permission: 'ventas.facturas.view',
    isCore: true,
    category: 'core',
  ...
  // === CUENTAS POR COBRAR ===
  {
    ...
    permission: 'ventas.cobranzas.view',
    isCore: true,
    category: 'core',
  ...
  },
  {
    ...
    permission: 'ventas.cuenta_corriente.view',
    isCore: true,
    category: 'core',
  ...
  // === MAESTROS ===
  {
    ...
    permission: 'ventas.clientes.view',
    isCore: true,
    category: 'core',
  ...
  },
  {
    ...
    permission: 'ventas.productos.view',
    isCore: true,
    category: 'core',
