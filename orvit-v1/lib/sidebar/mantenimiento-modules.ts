...
export const MANTENIMIENTO_MODULES: SidebarModule[] = [
  ...
  // ─── CORRECTIVO ───
  { id: 'mant.fallas', name: 'Incidentes', icon: 'AlertTriangle', path: '/mantenimiento/incidentes', isCore: true, category: 'core', description: 'Fallas y roturas de mantenimiento', order: 10 },
